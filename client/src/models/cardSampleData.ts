...
const cardSampleData: CardData[] = [
    ...
    {
        id: "4",
        Name: "Fourth Card Name",
        "Item Name": "Fourth Item Name",
        Measure: {
            type: "columnCustomComponents.pill",
            data: {
    ...
    {
        id: "5",
        Name: "Fifth Card Name",
        "Item Name": "Fifth Item Name",
        Measure: {
          type: "columnCustomComponents.pill",
          data: {
            title: "Fifth Measure",
        ...
        {
            id: "6",
            Name: "Sixth Card Name",
            "Item Name": "Sixth Item Name",
            Measure: {
            type: "columnCustomComponents.pill",
            data: {
                title: "Sixth Measure",
