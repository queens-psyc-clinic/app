    ...
    return (
      ...
      >
        <div className="bg-white z-60 space-y-6 rounded m-auto p-8 flex flex-col max-w-[490px]">
          ...
          <InputField label="Email" placeholder="email" important={true}/>
          <InputField label="New Password" placeholder="new password" important={true}/>
          <InputField label="Confirm New Password" placeholder="new password" important={true}/>
